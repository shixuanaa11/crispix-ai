import { ColorScale, ThemeColors } from './color.ts';
...
const themes = {
    ...
    rose: {
        50: 'oklch(0.973 0.014 12.422)',
        100: 'oklch(0.946 0.028 12.58)',
        200: 'oklch(0.898 0.057 10.001)',
        300: 'oklch(0.815 0.115 11.638)',
        400: 'oklch(0.717 0.193 13.428)',
        500: 'oklch(0.65 0.244 16.439)',
        600: 'oklch(0.591 0.251 17.585)',
        700: 'oklch(0.519 0.22 16.935)',
        800: 'oklch(0.46 0.187 13.697)',
        900: 'oklch(0.415 0.158 10.272)',
        950: 'oklch(0.276 0.104 12.094)',
    },
    slate: {
        50: 'oklch(0.986 0.003 247.858)',
        100: 'oklch(0.97 0.007 247.896)',
        200: 'oklch(0.931 0.013 255.508)',
        300: 'oklch(0.871 0.022 252.894)',
        400: 'oklch(0.706 0.04 256.788)',
        500: 'oklch(0.556 0.046 257.417)',
        600: 'oklch(0.448 0.043 257.281)',
        700: 'oklch(0.374 0.044 257.287)',
        800: 'oklch(0.28 0.041 260.031)',
        900: 'oklch(0.209 0.042 265.755)',
        950: 'oklch(0.13 0.042 264.695)',
    },
    gray: {
...
export function generateColorScale(baseColor: string): ColorScale {
    if (baseColor in themes) {
        return themes[baseColor as ThemeColorEnum];
    }
    return themes[ThemeColorEnum.ZINC];
}

export function updateCSSVariables(colors: ThemeColors) {
